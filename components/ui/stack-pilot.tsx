  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-gradient-to-br from-[#1a1d18] via-black to-[#2a2e26] text-[#e6e1d7] font-primary overflow-hidden relative w-full">
      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-between items-center px-8 py-12 md:px-16 md:py-20">
        ...
        <div className="text-center">
          <h2 className="text-xs md:text-sm font-mono font-light uppercase tracking-[0.2em] opacity-80" style={{ color: colors[200] }}>
            ...
            <span className="word" data-delay="400"><b>StackPilot</b></span>
            ...
            <span className="word" data-delay="1200">digital</span>
            <span className="word" data-delay="1400">transformation.</span>
          </h2>
          <div
        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="text-2xl md:text-3xl lg:text-4xl font-thin leading-relaxed" style={{ color: colors[200] }}>
              <span className="word" data-delay="2600">Integrate,</span>
              <span className="word" data-delay="2750">orchestrate,</span>
              ...
              <span className="word" data-delay="3350">business</span>
              ...
              <span className="word" data-delay="4100">platform.</span>
            </div>
          </h1>
          <div
            className="absolute -left-8 top-1/2 w-4 h-px opacity-20"
            style={{ background: colors[200], animation: "word-appear 1s ease-out forwards", animationDelay: "3.5s" }}
          ></div>
          <div
            className="absolute -right-8 top-1/2 w-4 h-px opacity-20"
            style={{ background: colors[200], animation: "word-appear 1s ease-out forwards", animationDelay: "3.7s" }}
          ></div>
        </div>
        ...
        <div className="text-center">
          ...
          <h2 className="text-xs md:text-sm font-mono font-light uppercase tracking-[0.2em] opacity-80" style={{ color: colors[200] }}>
            ...
            <span className="word" data-delay="5000">enterprise-grade</span>
            <span className="word" data-delay="5150">security.</span>
          </h2>
          <div
      ...
      <div
        ...
        style={{ background: `radial-gradient(circle, ${colors[500]}0D 0%, transparent 100%)` }}
      ></div>
    </div>
  );
}
